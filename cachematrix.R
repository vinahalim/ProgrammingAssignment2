...
## This function contains functions to set the value of the matrix, get the value of the matrix
...
## If the inverse has already been calculated (and thematrix has not changed), 
